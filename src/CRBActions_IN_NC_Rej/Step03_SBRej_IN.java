...
public Step03_SBRej_IN(WebDriver driver)
{
	this.driver=driver;
...
public void loginSB() throws InterruptedException
{
	...
	try {
		...
		String otpKeyStr = "Q6RRVK6RAHFWMJ7J";// bennett19@c25a0161.toronto.ca.ibm.com 
...
public void SB_Auth_IN ()
{
	...
	Step03_SBRej_IN popup = new Step03_SBRej_IN(driver);
