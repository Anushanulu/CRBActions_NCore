...
@FindBy (xpath = ".//*[@id='content-main']/form[1]/div/span/input") private WebElement Create_New_Request;
	...
	// Define all web elements under test displayed on home page
	    ...
	    @FindBy (id="FLD_REJ_REASON~0") private WebElement Reject_rason ;
	    @FindBy(name = "FLD_CMTS_TO_REQSTR") private WebElement  Comments_to_Requester ;
	    @FindBy (xpath="//*[@name='btnRejectSel']") private WebElement Reject_selected ;
	    @FindBy (xpath = "//*[@id='content-main']/form/table[4]/tbody/tr[2]/td[6]/a") private WebElement cand_name_link ;
	    @FindBy (name="btnRejectSelFin") private WebElement Reject ;
	    
		public static String xlsFilePath = System.getProperty("user.dir") + "\\src\\testdata\\testdata.xls";
		 public String sheet="Login";
	// Initialize the web elements 
	public Step04_CRBRej_IN(WebDriver driver)
	{
		this.driver=driver;
    ...
    public void crb_auth()
    {
		...
		wait04.until(ExpectedConditions.visibilityOf(Awaiting_CRB_auth_link));
				
		Awaiting_CRB_auth_link.click();
		
		WebDriverWait wait05 = new WebDriverWait(driver, 180);
		wait05.until(ExpectedConditions.visibilityOf(Skill_line_items));
		
		Skill_line_items.click();
		
		WebDriverWait wait06 = new WebDriverWait(driver, 180);
		wait06.until(ExpectedConditions.visibilityOf(Req_Num_Search));
		
		Req_Num_Search.sendKeys(Excel.getCellValue(xlsFilePath, "Request_creation", 6, 15));
		GO_reqnum.click();

		String Req_Num = Excel.getCellValue(xlsFilePath, "Request_creation", 6, 15) ;
		
		WebDriverWait wait07 = new WebDriverWait(driver, 160);
		wait07.until(ExpectedConditions.visibilityOf(Request_Number)); 
		
		Request_Number.click();
		
		WebDriverWait wait08 = new WebDriverWait(driver, 160);
		wait08.until(ExpectedConditions.visibilityOf(Select_Checkbox));
		...
		wait09.until(ExpectedConditions.visibilityOf(Reject));
		...
		wait10.until(ExpectedConditions.visibilityOf(Reject_rason));
		Select s1 = new Select(Reject_rason);
		s1.selectByValue("OTHR");

		Comments_to_Requester.sendKeys("Rejecting candidate");
			
		/* code to capture screenshot */
		Shutterbug.shootPage(driver, ScrollStrategy.BOTH_DIRECTIONS).save("C:\\Users\\SriSwathiAnushaNulu\\Documents\\Project csa\\Practice Automation\\Review\\NCore\\IND");
		
		Reject_selected.click();
