...
import CRBActions_GB_NC_Rej.Step05_PORej_GB;
import lib.Excel;


public class PORej_GB {
	...
	public void PO_Login() throws InterruptedException 
	{
		...
		Step05_PORej_GB login = new Step05_PORej_GB(driver);
		login.login();
	}
	...
	public void authorize_PO() 
	{
		...
		Step05_PORej_GB auth_PO = new Step05_PORej_GB(driver);
