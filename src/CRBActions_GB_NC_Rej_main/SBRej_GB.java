...
import CRBActions_GB_NC_Rej.Step03_SBRej_GB;
...
public class SBRej_GB
{
	...
	@Test(priority=1)
	public void SB_rej() throws InterruptedException 
	{

		Step03_SBRej_GB sb= new Step03_SBRej_GB (driver);
		sb.loginSB();
		sb.SB_open_Request ();
		sb.SB_Auth_req ();
	}
