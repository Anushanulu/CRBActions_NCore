...
import CRBActions_GB_NC_Rej.Step01_CreateRequestRej_GB;
...
public class CreateRequestRej_GB
{
	// TestNG logger
...
//		driver = new ChromeDriver();
	...
	public void RIPC_Login() throws InterruptedException, IOException 
	{
		...
		Step01_CreateRequestRej_GB login = new Step01_CreateRequestRej_GB(driver);
		login.login();
	}
	@Test(priority=1)
	public void Create_Req() 
	{
		...
		Step01_CreateRequestRej_GB createreq = new Step01_CreateRequestRej_GB(driver);
	...
	public void skill_Req() 
	{
		...
		Step01_CreateRequestRej_GB skillreq = new Step01_CreateRequestRej_GB(driver);
	...
	public void select_Req() 
	{
		...
		Step01_CreateRequestRej_GB selectreq = new Step01_CreateRequestRej_GB(driver);
	...
	public void req_detail() 
	{
		...
		Step01_CreateRequestRej_GB reqdetail = new Step01_CreateRequestRej_GB(driver);
	...
	public void skill_loc() 
	{
		...
		Step01_CreateRequestRej_GB skillloc = new Step01_CreateRequestRej_GB(driver);
	...
	public void alert_check() 
	{
		...
		Step01_CreateRequestRej_GB alertchk = new Step01_CreateRequestRej_GB(driver);
	...
	public void skill_price() 
	{
		...
		Step01_CreateRequestRej_GB skillprice = new Step01_CreateRequestRej_GB(driver);
	...
	public void supp() 
	{
		...
		Step01_CreateRequestRej_GB supplier = new Step01_CreateRequestRej_GB(driver);
