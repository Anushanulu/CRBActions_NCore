...
import CRBActions_GB_NC_Rej.Step04_CRBRej_GB;
...
//		driver = new ChromeDriver();
	...
	public void CRB_Wlcmpage() throws InterruptedException 
	{
		...
		Step04_CRBRej_GB login = new Step04_CRBRej_GB(driver);
		login.login();
	}
	@Test(priority=1)
	public void CRB_auth() 
	{
		...
		Step04_CRBRej_GB crbauth = new Step04_CRBRej_GB(driver);
		crbauth.CRB_Auth();
	}
