...
public Step04_CRBRej_GB(WebDriver driver)
{
	this.driver=driver;
...
public void login() throws InterruptedException
{
	...
	try {
		...
		String otpKeyStr = "YRHYYJ33TYG462YC";// bennett08@c25a0161.toronto.ca.ibm.com
...
public void CRB_Auth()
{
	...
	Req_Num_Search.sendKeys(Excel.getCellValue(xlsFilePath, "Request_creation", 5, 15));
	GO_reqnum.click();

	String Req_Num = Excel.getCellValue(xlsFilePath, "Request_creation", 5, 15) ;
	...
	wait08.until(ExpectedConditions.visibilityOf(Reject_rason)); 
	Select s1 = new Select(Reject_rason);
	s1.selectByValue("OTHR");

	CommentsToRequester.sendKeys("Rejecting candidate");
