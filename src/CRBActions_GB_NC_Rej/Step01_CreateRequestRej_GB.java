...
public class Step01_CreateRequestRej_GB {
...
public Step01_CreateRequestRej_GB(WebDriver driver)
{
	this.driver=driver;
...
//	System.out.println("REQUEST ID ="+Number);
	...
	Excel.setCellValue(xlsFilePath, "Request_creation", 5, 15, RequestNumber );
