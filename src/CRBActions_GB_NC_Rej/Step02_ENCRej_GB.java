...
@FindBy (name ="btnSaveAndAuth" ) private WebElement Authorize_btn ;
	...
	public Step02_ENCRej_GB(WebDriver driver)
	{
		this.driver=driver;
	...
	public void loginENC() throws InterruptedException
	{
		...
		login_username.sendKeys(Excel.getCellValue(xlsFilePath, sheet, 8, 0));
		Thread.sleep(1000);
		login_password.clear();
		login_password.sendKeys(Excel.getCellValue(xlsFilePath, sheet, 8, 1));
