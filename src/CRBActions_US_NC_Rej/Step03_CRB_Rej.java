...
public Step03_CRB_Rej(WebDriver driver)
{
	this.driver=driver;
...
public void CRB_Rej()
{
	...
	Req_Num_Search.sendKeys(Excel.getCellValue(xlsFilePath, "Request_creation", 4, 15));
	GO_reqnum.click();

	String Req_Num = Excel.getCellValue(xlsFilePath, "Request_creation", 4, 15) ;
	...
	wait07.until(ExpectedConditions.visibilityOf(Reject_rason));
