...
import CRBActions_IN_NC.Step02_ENCAuth_IN;
...
//		driver = new ChromeDriver();
	...
	public void ENC_Wlcmpage() throws InterruptedException 
	{
		...
		Step02_ENCAuth_IN login = new Step02_ENCAuth_IN(driver);
		login.loginENC();
	...
	public void ENC_auth() 
	{
		...
		Step02_ENCAuth_IN encauth = new Step02_ENCAuth_IN(driver);
		encauth.submit_req();
	}
}
