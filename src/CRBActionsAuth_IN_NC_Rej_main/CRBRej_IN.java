...
import CRBActions_IN_NC_Rej.Step04_CRBRej_IN;
...
//		driver = new ChromeDriver();
	...
	public void CRB_Wlcmpage() throws InterruptedException 
	{
		...
		Step04_CRBRej_IN crblogin = new Step04_CRBRej_IN(driver);
		crblogin.login();
	}
	@Test(priority=1)
	public void CRB_switch() 
	{
		...
		Step04_CRBRej_IN switching = new Step04_CRBRej_IN(driver);
	...
	public void CRB_auth() 
	{
		...
		Step04_CRBRej_IN auth = new Step04_CRBRej_IN(driver);
		auth.crb_auth();
	}
