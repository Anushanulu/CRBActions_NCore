...
import CRBActions_IN_NC_Rej.Step01_CreateRequestRej_IN;
...
public class CreateRequestRej_IN
{
	// TestNG logger
...
//		driver = new ChromeDriver();
	...
	public void RIPC_Login() throws InterruptedException 
	{
		...
		Step01_CreateRequestRej_IN login = new Step01_CreateRequestRej_IN(driver);
		login.login();
