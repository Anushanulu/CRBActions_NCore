...
public class Step04_CRBAuth_IN {
...
@FindBy (xpath = ".//*[@id='content-main']/form[1]/div/span/input") private WebElement Create_New_Request;
	...
	public Step04_CRBAuth_IN(WebDriver driver)
	{
		this.driver=driver;
    ...
    public void crb_auth()
    {
		...
		wait09.until(ExpectedConditions.visibilityOf(Authorize_Button)); 
		...
		wait10.until(ExpectedConditions.visibilityOf(CommentsToRequester)); 
