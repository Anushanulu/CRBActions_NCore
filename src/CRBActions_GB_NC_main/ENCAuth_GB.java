...
import CRBActions_GB_NC.Step02_ENCAuth_GB;
...
//		driver = new ChromeDriver();
	...
	public void ENC_Wlcmpage() throws InterruptedException 
	{
		...
		Step02_ENCAuth_GB login = new Step02_ENCAuth_GB(driver);
		login.loginENC();
	...
	public void ENC_auth() 
	{
		...
		Step02_ENCAuth_GB encauth = new Step02_ENCAuth_GB(driver);
		encauth.submit_req();
	}
}
