...
import CRBActions_GB_NC.Step04_CRBAuth_GB;
...
//		driver = new ChromeDriver();
	...
	public void CRB_Wlcmpage() throws InterruptedException 
	{
		...
		Step04_CRBAuth_GB login = new Step04_CRBAuth_GB(driver);
		login.login();
	}
	@Test(priority=1)
	public void CRB_auth() 
	{
		...
		Step04_CRBAuth_GB crbauth = new Step04_CRBAuth_GB(driver);
		crbauth.CRB_Auth();
	}
